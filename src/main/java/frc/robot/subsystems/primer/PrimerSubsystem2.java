package frc.robot.subsystems.primer;
 ...
 * near the shooter.
 */
public class PrimerSubsystem2 extends SubsystemBase {
  private PrimerState State;
  ...
  public void periodic() {
    ...
    if (State == PrimerState.Indexing){
        primerRoller.set(PrimerConstants.kIntake);
        if (isPrimerBeamBreakBroken()){
            tempPosition = primerRoller.getPosition().getValueAsDouble();
            State = PrimerState.Stowing;
