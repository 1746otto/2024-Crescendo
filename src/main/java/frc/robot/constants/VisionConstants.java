...
public class VisionConstants {
    ...
    public static final Transform3d[] kCameraTransforms = {
        new Transform3d(new Translation3d(Units.inchesToMeters(-6.868435), 0, Units.inchesToMeters(12.5)), new Rotation3d(0, Units.degreesToRadians(-20), Units.degreesToRadians(180))), 
        new Transform3d(new Pose3d(), new Pose3d(-0.5, 0, 0.5, new Rotation3d()))
    }; // TODO: Get the actual transforms for the cameras.
    public static final Vector<N3> kVisionStdDeviations = VecBuilder.fill(2.7, 2.7, 30); // TODO: Tune these values for our robot.
